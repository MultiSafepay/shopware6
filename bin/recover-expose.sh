...
#
# PURPOSE
#   Recover Shopware 6.6 public tunnel connectivity when Expose cannot reach
...
#   ./bin/recover-expose.sh shopware-dev-xxx.multisafepay.io
...
usage() {
  cat <<'EOF'
Recover Expose connectivity for Shopware 6.6.
...
log "============================================================"
log "Shopware 6.6 - Expose Recovery"
