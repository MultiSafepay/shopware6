 ...
 * Class Paysafecard
 *
 * This class is used to define the details of Paysafecard payment method
 *
...
class Paysafecard implements PaymentMethodInterface
{
    ...
    {
        return PaysafecardPaymentHandler::class;
    }
    ...
    {
        return __DIR__  . '/../Resources/views/storefront/multisafepay/logo/paysafecard.png';
    }
