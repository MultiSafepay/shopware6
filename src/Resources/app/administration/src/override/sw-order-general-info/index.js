    ...
    computed: {
        paymentMethodDisplay() {
            ...
            if (this.order
                ...
                && this.order.primaryOrderTransaction.customFields.multisafepay_payment_method_display_admin
            ) {
                return this.order.primaryOrderTransaction.customFields.multisafepay_payment_method_display_admin;
            }

            if (this.order
                && this.order.primaryOrderTransaction
                && this.order.primaryOrderTransaction.customFields
                && this.order.primaryOrderTransaction.customFields.multisafepay_payment_method_display
            ) {
                return this.order.primaryOrderTransaction.customFields.multisafepay_payment_method_display;
            }
            ...
            if (this.order
                ...
                const primaryPaymentMethod = this.order.primaryOrderTransaction.paymentMethod;

                if (primaryPaymentMethod.translated && primaryPaymentMethod.translated.distinguishableName) {
                    return primaryPaymentMethod.translated.distinguishableName;
                }

                if (primaryPaymentMethod.translated && primaryPaymentMethod.translated.name) {
                    return primaryPaymentMethod.translated.name;
                }

                if (primaryPaymentMethod.name) {
                    return primaryPaymentMethod.name;
                }
            }
