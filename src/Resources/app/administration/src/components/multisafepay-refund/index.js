...
Component.register('multisafepay-refund', {
    ...
    methods: {
        ...
        translateRefundSnippet(snippetKey, replacements = {}) {
            const translated = this.$tc(`multisafepay-refund.${snippetKey}`);
    ...
    computed: {
        ...
        refundAmountStatusMessage() {
            ...
            if (this.refundMissingInMultiSafepay) {
                return this.$tc('multisafepay-refund.refund_missing_in_multisafepay');
            }
        ...
        confirmRefundMessage() {
            return this.$tc('multisafepay-refund.confirm_refund_message', 0, {
