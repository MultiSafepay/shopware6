 ...
 *
 * This class is used to handle the payment process for Generic5
 *
 * @package MultiSafepay\Shopware6\Handlers
 */
class GenericPaymentHandler5 extends AsyncPaymentHandler
{
    /**
     * @var SettingsService
     */
    ...
    public function pay(
        ...
        $paymentMethod = new Generic5();

        return parent::pay(
            $transaction,
            $dataBag,
            $salesChannelContext,
            $this->settingsService->getSetting('genericGatewayCode5', $salesChannelContext->getSalesChannelId()),
