...
/**
 * Class IngHomePayPaymentHandlerTest
 *
 * @package MultiSafepay\Shopware6\Tests\Unit\Handlers
 */
class IngHomePayPaymentHandlerTest extends TestCase
{
    /**
     * @var IngHomePayPaymentHandler
     */
    private IngHomePayPaymentHandler $paymentHandler;
    ...
    public function testGetClassName(): void
    {
        ...
        $this->assertEquals(IngHomePay::class, $result);
    }
