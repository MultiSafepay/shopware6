...
/**
 * Class NationaleVerwenCadeaubonPaymentHandlerTest
 *
 * @package MultiSafepay\Shopware6\Tests\Unit\Handlers
 */
class NationaleVerwenCadeaubonPaymentHandlerTest extends TestCase
{
    /**
     * @var NationaleVerwenCadeaubonPaymentHandler
     */
    private NationaleVerwenCadeaubonPaymentHandler $paymentHandler;
    ...
    public function testGetClassName(): void
    {
        ...
        $this->assertEquals(NationaleVerwenCadeaubon::class, $result);
    }
